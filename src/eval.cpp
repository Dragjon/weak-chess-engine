...
const int32_t PSQT[6][64] = {
    {
        ...
        S(81, 156), S(95, 171), S(93, 155), S(96, 140), S(112, 99), S(147, 104), S(132, 145), S(101, 131),
    ...
    },
    {
        ...
        S(111, 144), S(113, 127), S(101, 120), S(118, 122), S(99, 117), S(155, 102), S(126, 121), S(149, 124),
        S(113, 117), S(115, 119), S(158, 169), S(159, 174), S(189, 162), S(203, 148), S(127, 114), S(133, 110),
        S(116, 130), S(91, 134), S(144, 178), S(165, 179), S(135, 185), S(162, 182), S(88, 140), S(140, 123),
    ...
    },
    {
        ...
        S(125, 174), S(139, 164), S(138, 161), S(142, 154), S(131, 161), S(160, 164), S(143, 165), S(133, 177),
    ...
    {
        S(178, 306), S(164, 313), S(164, 322), S(161, 319), S(172, 313), S(196, 307), S(184, 312), S(200, 304),
        ...
        S(130, 302), S(135, 297), S(144, 295), S(147, 297), S(149, 294), S(147, 287), S(168, 272), S(152, 277),
    ...
    },
    {
        ...
        S(349, 557), S(330, 576), S(327, 608), S(316, 627), S(308, 644), S(356, 592), S(358, 581), S(391, 578),
        S(356, 558), S(348, 569), S(349, 591), S(347, 599), S(356, 605), S(380, 586), S(389, 563), S(376, 569),
        S(339, 575), S(346, 577), S(341, 586), S(337, 603), S(337, 605), S(346, 594), S(354, 594), S(352, 584),
        S(349, 564), S(338, 580), S(339, 578), S(344, 591), S(340, 590), S(342, 578), S(347, 574), S(355, 574),
        S(345, 547), S(351, 558), S(346, 569), S(343, 564), S(345, 570), S(348, 563), S(359, 545), S(354, 554),
        S(353, 545), S(353, 544), S(361, 539), S(356, 548), S(356, 550), S(357, 520), S(363, 501), S(378, 491),
        S(348, 547), S(348, 542), S(354, 541), S(358, 552), S(357, 530), S(335, 531), S(348, 521), S(358, 516)
    },
    {
...
const int32_t mobilities[5][28] = {
    ...
    {
        S(0, 0), S(0, 0), S(0, 0), S(434, 356), S(421, 439), S(446, 486), S(446, 505), S(444, 565), S(447, 575), S(445, 594), S(448, 600), S(450, 610), S(451, 622), S(453, 624), S(455, 629), S(455, 637), S(454, 643), S(455, 649), S(454, 654), S(455, 657), S(456, 664), S(459, 661), S(461, 661), S(469, 655), S(469, 654), S(484, 646), S(520, 623), S(571, 595),
    },
    {
        S(0, 0), S(0, 0), S(0, 0), S(45, -8), S(49, -11), S(32, 3), S(25, 4), S(23, -1), S(19, 0), S(15, 0), S(13, 0), S(6, 5), S(5, 2), S(-2, 5), S(-11, 6), S(-22, 8), S(-35, 8), S(-50, 7), S(-62, 7), S(-75, 4), S(-74, -1), S(-78, -6), S(-83, -11), S(-91, -17), S(-103, -22), S(-85, -37), S(-99, -41), S(-76, -54),
    },
};
...
const int32_t pawn_storm[64] = {
    S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
    S(21, -58), S(-41, -51), S(-6, -87), S(-7, -52), S(-60, 55), S(-44, -3), S(-12, 2), S(-48, 5),
...
const int32_t isolated_pawns[64] = {
    S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
    S(47, -24), S(110, -106), S(53, -9), S(53, -4), S(17, 8), S(7, 29), S(-32, 29), S(0, -1),
...
const int32_t knight_outposts[64] = {
    S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
    S(0, 0), S(-175, 157), S(54, -28), S(91, 187), S(1, -22), S(38, -85), S(-60, 147), S(0, 0),
    S(0, 0), S(-39, 23), S(-24, 60), S(6, 10), S(33, 79), S(0, 73), S(0, 39), S(0, 0),
    S(0, 0), S(13, 12), S(3, 39), S(-7, 49), S(11, 74), S(27, 16), S(43, 6), S(0, 0),
    S(0, 0), S(10, 79), S(24, 49), S(21, 54), S(36, 59), S(47, 33), S(38, 10), S(0, 0),
    S(0, 0), S(-139, 19), S(80, 125), S(-8, -21), S(-167, -84), S(-165, -110), S(36, -49), S(0, 0),
    S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
    S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0)
};
