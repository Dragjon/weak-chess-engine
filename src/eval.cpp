...
const int32_t PSQT[6][64] = {
    {
        ...
        S(45, 184), S(74, 197), S(69, 180), S(79, 144), S(79, 119), S(79, 129), S(48, 152), S(34, 159),
        ...
        S(83, 96), S(112, 100), S(103, 95), S(81, 108), S(75, 120), S(96, 100), S(103, 97), S(74, 77),
        S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0)
    },
    {
        S(14, 81), S(21, 142), S(57, 128), S(86, 119), S(121, 116), S(46, 100), S(45, 136), S(63, 59),
        S(100, 143), S(104, 125), S(83, 124), S(102, 124), S(97, 115), S(121, 106), S(107, 116), S(126, 125),
        ...
        S(108, 132), S(95, 129), S(138, 176), S(136, 179), S(145, 182), S(142, 168), S(114, 126), S(117, 123),
        S(94, 119), S(87, 124), S(122, 160), S(128, 172), S(138, 169), S(132, 155), S(105, 117), S(111, 118),
        S(104, 144), S(89, 124), S(74, 121), S(89, 121), S(88, 119), S(84, 117), S(102, 113), S(128, 152),
        S(87, 138), S(114, 135), S(79, 120), S(92, 119), S(96, 120), S(99, 111), S(115, 143), S(114, 125)
    },
    {
        S(111, 170), S(90, 176), S(95, 167), S(57, 178), S(73, 172), S(80, 166), S(114, 163), S(79, 165),
        S(103, 163), S(117, 163), S(114, 163), S(107, 162), S(108, 157), S(120, 158), S(97, 171), S(103, 162),
        S(124, 175), S(136, 165), S(132, 163), S(134, 158), S(129, 162), S(151, 166), S(141, 165), S(129, 176),
        ...
        S(125, 170), S(138, 166), S(133, 165), S(131, 164), S(134, 168), S(138, 162), S(142, 159), S(146, 160),
        S(142, 169), S(138, 154), S(141, 149), S(128, 159), S(135, 158), S(139, 154), S(153, 158), S(146, 152),
        S(135, 158), S(146, 164), S(135, 159), S(124, 164), S(128, 162), S(126, 171), S(135, 156), S(154, 139)
    },
    {
        S(158, 304), S(150, 308), S(154, 316), S(153, 314), S(156, 306), S(180, 301), S(161, 305), S(181, 299),
        S(155, 300), S(156, 306), S(170, 312), S(185, 303), S(171, 305), S(196, 290), S(192, 287), S(205, 281),
        S(150, 295), S(174, 291), S(167, 294), S(170, 289), S(195, 281), S(203, 273), S(223, 270), S(196, 272),
        S(148, 298), S(159, 292), S(161, 298), S(168, 294), S(163, 285), S(176, 276), S(170, 280), S(171, 278),
        S(137, 297), S(131, 299), S(142, 298), S(151, 296), S(148, 295), S(143, 289), S(150, 283), S(147, 282),
        S(132, 298), S(131, 294), S(138, 294), S(142, 296), S(145, 292), S(148, 283), S(162, 269), S(150, 275),
        S(135, 293), S(139, 294), S(149, 294), S(151, 292), S(154, 287), S(153, 282), S(165, 273), S(143, 282),
        S(153, 301), S(150, 296), S(153, 300), S(159, 293), S(159, 290), S(150, 295), S(157, 286), S(155, 287)
    },
    {
        S(327, 564), S(320, 571), S(338, 585), S(365, 571), S(348, 574), S(359, 572), S(403, 524), S(360, 559),
        S(348, 551), S(334, 562), S(331, 594), S(319, 611), S(311, 629), S(358, 572), S(362, 567), S(388, 571),
        S(358, 549), S(351, 555), S(353, 575), S(351, 582), S(359, 585), S(384, 572), S(393, 547), S(378, 562),
        S(341, 568), S(349, 567), S(345, 574), S(344, 587), S(343, 589), S(351, 581), S(359, 584), S(357, 576),
        S(351, 559), S(339, 574), S(343, 570), S(348, 581), S(345, 579), S(347, 570), S(352, 566), S(357, 571),
        S(346, 545), S(353, 553), S(348, 565), S(344, 561), S(347, 564), S(349, 559), S(361, 541), S(356, 550),
        S(350, 547), S(352, 544), S(359, 538), S(355, 549), S(355, 550), S(354, 522), S(361, 502), S(374, 496),
        S(345, 552), S(346, 543), S(350, 543), S(354, 556), S(352, 535), S(332, 534), S(342, 525), S(356, 520)
    },
    {
        S(74, -119), S(70, -68), S(104, -53), S(-21, -6), S(-39, 4), S(-31, 5), S(43, -14), S(169, -114),
        S(-58, -28), S(43, -7), S(20, 9), S(108, 2), S(21, 40), S(11, 47), S(31, 29), S(-17, 8),
        S(-77, -19), S(77, -6), S(37, 20), S(20, 36), S(22, 60), S(60, 45), S(25, 32), S(-37, 10),
        S(-42, -27), S(-3, 0), S(-8, 26), S(-45, 49), S(-71, 76), S(-50, 60), S(-65, 37), S(-126, 23),
        S(-58, -29), S(-14, -5), S(-24, 21), S(-51, 42), S(-71, 74), S(-39, 50), S(-58, 33), S(-131, 21),
        S(-26, -33), S(21, -13), S(-6, 8), S(-16, 20), S(-25, 52), S(-18, 40), S(-1, 19), S(-52, 10),
        S(30, -45), S(30, -20), S(22, -9), S(-1, 0), S(-18, 35), S(-5, 26), S(25, 8), S(4, -7),
...
const int32_t mobilities[5][28] = {
    ...
    {
        S(0, 0), S(0, 0), S(115, 195), S(140, 192), S(165, 226), S(0, 0), S(198, 238), S(0, 0), S(176, 209), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
    },
    {
        S(0, 0), S(120, 142), S(136, 138), S(140, 169), S(154, 178), S(159, 187), S(169, 202), S(174, 209), S(180, 217), S(182, 222), S(185, 227), S(184, 225), S(187, 223), S(204, 220), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
    },
    {
        S(0, 0), S(0, 0), S(197, 304), S(201, 321), S(206, 330), S(208, 336), S(209, 339), S(209, 345), S(212, 347), S(215, 350), S(217, 355), S(219, 359), S(220, 365), S(223, 369), S(222, 374), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
    },
    {
        S(0, 0), S(0, 0), S(0, 0), S(445, 348), S(435, 416), S(459, 471), S(462, 493), S(458, 555), S(461, 569), S(458, 590), S(461, 597), S(462, 609), S(463, 620), S(465, 623), S(467, 628), S(467, 636), S(467, 642), S(468, 647), S(467, 653), S(467, 657), S(468, 665), S(470, 664), S(471, 665), S(479, 660), S(477, 661), S(492, 655), S(526, 634), S(574, 608),
    },
    {
        S(0, 0), S(0, 0), S(0, 0), S(46, -8), S(52, -18), S(36, 0), S(27, 0), S(23, -5), S(19, -3), S(15, -3), S(14, -4), S(6, 1), S(5, -1), S(-2, 1), S(-11, 3), S(-21, 5), S(-35, 6), S(-51, 6), S(-63, 6), S(-78, 6), S(-78, 2), S(-83, 0), S(-90, -2), S(-98, -7), S(-113, -7), S(-97, -19), S(-111, -17), S(-87, -31),
    },
};
...
const int32_t passed_pawns[64] = {
    ...
    S(14, 79), S(18, 77), S(19, 53), S(15, 48), S(3, 47), S(10, 54), S(-1, 72), S(-10, 79),
...
const int32_t pawn_storm[64] = {
    S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
    S(21, -59), S(-35, -53), S(-5, -91), S(-17, -48), S(-61, 49), S(-51, -10), S(-3, -9), S(-35, 2),
...
const int32_t isolated_pawns[64] = {
    ...
    S(11, -17), S(14, -48), S(3, -25), S(5, -12), S(2, -17), S(-2, -8), S(22, -28), S(7, -25),
