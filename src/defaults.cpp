...
SearchParam quiet_history_pruning_quad("QuietHistoryPruningQuad", 2300, 786, 8192, 64);
...
SearchParam history_reduction_div("HistoryReductionDiv", 24576, 8192, 32768, 128);
